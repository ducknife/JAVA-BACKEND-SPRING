...
- [🎯 Mục tiêu](#mục-tiêu)
- [1. File cấu hình là gì?](#1-file-cấu-hình-là-gì)
- [2. Hai định dạng: .properties vs .yml](#2-hai-định-dạng-properties-vs-yml)
  - [application.properties:](#applicationproperties)
  - [application.yml (YAML):](#applicationyml-yaml)
  - [So sánh:](#so-sánh)
- [3. Các cấu hình phổ biến](#3-các-cấu-hình-phổ-biến)
  - [Server:](#server)
  - [Database:](#database)
  - [JPA/Hibernate:](#jpahibernate)
  - [Logging:](#logging)
- [Các Log Level (từ thấp → cao):](#các-log-level-từ-thấp-cao)
- [4. Đọc cấu hình trong code](#4-đọc-cấu-hình-trong-code)
  - [Cách 1: @Value (đơn giản)](#cách-1-value-đơn-giản)
  - [Cách 2: @ConfigurationProperties (khuyên dùng)](#cách-2-configurationproperties-khuyên-dùng)
  - [So sánh:](#so-sánh)
- [5. Custom Properties](#5-custom-properties)
- [6. Profile là gì?](#6-profile-là-gì)
- [7. Tạo Profile files](#7-tạo-profile-files)
  - [Cấu trúc:](#cấu-trúc)
  - [application.properties (chung):](#applicationproperties-chung)
  - [application-dev.properties:](#application-devproperties)
  - [application-prod.properties:](#application-prodproperties)
- [8. Kích hoạt Profile](#8-kích-hoạt-profile)
  - [Cách 1: Trong application.properties:](#cách-1-trong-applicationproperties)
  - [Cách 2: Command line:](#cách-2-command-line)
  - [Cách 3: Environment variable:](#cách-3-environment-variable)
  - [Cách 4: IDE (IntelliJ/VS Code):](#cách-4-ide-intellijvs-code)
- [9. Ưu tiên cấu hình](#9-ưu-tiên-cấu-hình)
- [10. @Profile - Bean theo môi trường](#10-profile-bean-theo-môi-trường)
  - [Các cách dùng @Profile:](#các-cách-dùng-profile)
- [11. Sử dụng Environment Variables](#11-sử-dụng-environment-variables)
  - [Trong application.properties:](#trong-applicationproperties)
  - [Tại sao dùng env var?](#tại-sao-dùng-env-var)
- [12. Lombok là gì?](#12-lombok-là-gì)
  - [Trước khi có Lombok:](#trước-khi-có-lombok)
  - [Sau khi có Lombok:](#sau-khi-có-lombok)
- [13. Cài đặt Lombok](#13-cài-đặt-lombok)
  - [Maven (pom.xml):](#maven-pomxml)
  - [IDE Plugin:](#ide-plugin)
- [14. Các Annotation phổ biến](#14-các-annotation-phổ-biến)
...
- [15. Kết hợp thực tế](#15-kết-hợp-thực-tế)
  - [Entity:](#entity)
  - [DTO:](#dto)
  - [Service:](#service)
  - [Controller:](#controller)
- [16. Lưu ý khi dùng Lombok](#16-lưu-ý-khi-dùng-lombok)
  - [⚠️ @Data với Entity:](#️-data-với-entity)
  - [⚠️ IDE cần plugin:](#️-ide-cần-plugin)
- [📌 Tóm tắt](#tóm-tắt)
