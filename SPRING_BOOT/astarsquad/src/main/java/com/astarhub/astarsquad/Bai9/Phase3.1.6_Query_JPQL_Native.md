...
## 📑 Mục Lục
  ...
  - [1. Làm sao tìm "Top 3 sản phẩm bán chạy nhất"?](#1-làm-sao-tìm-top-3-sản-phẩm-bán-chạy-nhất)
  - [2. Làm sao để không bị "cứng" với cái tên `findBy...`?](#2-làm-sao-để-không-bị-cứng-với-cái-tên-findby)
  - [Cách 1: JPQL (Java Persistence Query Language) - Khuyên dùng ⭐️](#cách-1-jpql-java-persistence-query-language-khuyên-dùng-️)
  - [Cách 2: Native Query (SQL Thuần)](#cách-2-native-query-sql-thuần)
  - [🧠 Thử thách tư duy (Critical Thinking)](#thử-thách-tư-duy-critical-thinking)
