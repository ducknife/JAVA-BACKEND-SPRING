...
- [📌 Phase 4: Spring Security — Tổng Quan Kiến Trúc](#-phase-4-spring-security--tổng-quan-kiến-trúc)
  - [📖 Mục Lục Phase 4](#-mục-lục-phase-4)
  - [📑 Mục Lục](#-mục-lục)
  - [1. Spring Security Là Gì?](#1-spring-security-là-gì)
    - [Tại sao cần Spring Security?](#tại-sao-cần-spring-security)
  - [2. Kiến Trúc Tổng Quan — Servlet Filter Chain](#2-kiến-trúc-tổng-quan--servlet-filter-chain)
    ...
    - [2.2 Ba Thành Phần Chính](#22-ba-thành-phần-chính)
      - [(1) DelegatingFilterProxy — Cầu Nối](#1-delegatingfilterproxy--cầu-nối)
      - [(2) FilterChainProxy — Bộ Điều Phối](#2-filterchainproxy--bộ-điều-phối)
      - [(3) SecurityFilterChain — Chuỗi Filter Bảo Mật](#3-securityfilterchain--chuỗi-filter-bảo-mật)
  - [3. Các Khái Niệm Cốt Lõi](#3-các-khái-niệm-cốt-lõi)
    - [3.1 SecurityContext \& SecurityContextHolder](#31-securitycontext--securitycontextholder)
      ...
      - [Code minh họa — Lấy thông tin user hiện tại:](#code-minh-họa--lấy-thông-tin-user-hiện-tại)
  ...
  - [4. Luồng Xác Thực (Authentication Flow)](#4-luồng-xác-thực-authentication-flow)
    - [4.1 Các Thành Phần Tham Gia](#41-các-thành-phần-tham-gia)
      - [Giải thích từng thành phần:](#giải-thích-từng-thành-phần-1)
    - [4.2 Luồng Chi Tiết (Username/Password + JWT)](#42-luồng-chi-tiết-usernamepassword--jwt)
  - [5. Cấu Hình SecurityFilterChain — Nền Tảng Cho Cả Phase](#5-cấu-hình-securityfilterchain--nền-tảng-cho-cả-phase)
    - [5.1 Project Structure](#51-project-structure)
    - [5.2 SecurityConfig.java — Base (Sẽ mở rộng ở các file sau)](#52-securityconfigjava--base-sẽ-mở-rộng-ở-các-file-sau)
    - [5.3 Giải Thích Từng Dòng Config](#53-giải-thích-từng-dòng-config)
      - [`@EnableWebSecurity`](#enablewebsecurity)
      - [`@EnableMethodSecurity`](#enablemethodsecurity)
      - [`SessionCreationPolicy.STATELESS`](#sessioncreationpolicystateless)
      - [`authorizeHttpRequests()` — Cách Hoạt Động](#authorizehttprequests--cách-hoạt-động)
  - [6. Dependency](#6-dependency)
  - [7. Tóm Tắt: Kiến Trúc Bạn Cần Nhớ](#7-tóm-tắt-kiến-trúc-bạn-cần-nhớ)
  - [✅ Checklist — Sau Khi Đọc File Này](#-checklist--sau-khi-đọc-file-này)
